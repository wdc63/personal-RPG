...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.jiapush = QtWidgets.QCheckBox()
        ...
        def getandrewrite():
            ...
            if 0 == 0:
                self.jiapush.setChecked(True)
                MainWindow.close()
            else:
                import dengluxiaoxi
                global dengluxiaoxi
                dengluxiaoxi.Dialog.show()
                dengluxiaoxi.ui.pushButton.clicked.connect(self.lineEdit.clear)
                dengluxiaoxi.ui.pushButton.clicked.connect(self.lineEdit_2.clear)


#上面几排演示了如何在窗口之间来传递消息的方法#

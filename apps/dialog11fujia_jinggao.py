...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; color:#ff0000;\">因计划或外部原因发生改变才能废弃任务，你确定没有欺骗自己？</span></p></body></html>"))
